...
enum BiomarkerId {
    ...
    static let redBloodCell = 16
    static let meanCorpuscularVolume = 17
    ...
    static let shbg = 36
    static let meanCorpuscularHemoglobin = 37
    ...
    static let redBloodCellDistributionWidthSD = 43
    static let redBloodCellDistributionWidthCV = 44
    static let methylmalonicAcid = 45
    static let hyperHe = 46
    static let iron = 47
    static let ferritin = 48
    static let totalIronBindingCapacity = 49
    static let hypoHe = 50
    static let parathyroidHormone = 51
    static let rbc = 52
    static let vitaminD25Hydroxy = 53
    static let vitaminD125dihydroxy = 54
    static let phosphorus = 55
    static let t3 = 56
    static let thyroidStimulatingHormone = 57
    static let thyroidStimulatingImmunoglobulin = 58
    static let thyroidPeroxidaseAntibody = 59
    static let erythrocyteSedimentationRate = 60
    static let highSensitivityCReactiveProtein = 61
    static let thyroglobulinAntibody = 62
    static let totalTestosterone = 63
    static let freeTestosteron = 64
    static let luteinizingHormone = 65
    static let follicleStimulatingHormone = 66
    static let androstendione = 67
    static let dehydroepiandrosteroneSulfate = 68
    static let dehydroepiandrosterone = 69
    static let freeAndrogenIndex = 70
    static let hydroxyprogesterone17 = 71
    static let antiMullerianHormone = 72
    static let estradiol = 73
    static let inhibinB = 74
    static let hdlCholesterol = 75
    static let platelets = 76
