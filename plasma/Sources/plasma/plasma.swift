        ...
        self.init(rules: [
            ...
            PlasmaRule(
                ...
                biomarkerIds: [
                    ...
                    BiomarkerId.meanCorpuscularVolume,
                    BiomarkerId.meanCorpuscularHemoglobin,
                    BiomarkerId.iron,
                    BiomarkerId.ferritin,
                    BiomarkerId.totalIronBindingCapacity,
                    BiomarkerId.redBloodCell,
                    BiomarkerId.redBloodCellDistributionWidthCV,
                    BiomarkerId.redBloodCellDistributionWidthSD,
                    BiomarkerId.hypoHe],
                evaluate: { values in
            ...
            PlasmaRule(
                id: 22,
                biomarkerIds:[
                    BiomarkerId.parathyroidHormone,
                    BiomarkerId.calcium,
                    BiomarkerId.vitaminD25Hydroxy,
                    BiomarkerId.vitaminD125dihydroxy,
            ...
            PlasmaRule(
                ...
                biomarkerIds: [
                    ...
                    BiomarkerId.t3,
                    BiomarkerId.t4,
                    BiomarkerId.thyroidStimulatingHormone,
                    BiomarkerId.thyroidStimulatingImmunoglobulin,
                    BiomarkerId.thyroidPeroxidaseAntibody,
                    BiomarkerId.erythrocyteSedimentationRate,
                    BiomarkerId.crp,
                    BiomarkerId.highSensitivityCReactiveProtein,
            ...
            PlasmaRule(
                id: 25,
                biomarkerIds: [
                    BiomarkerId.totalTestosterone,
                    BiomarkerId.freeTestosteron,
                    BiomarkerId.luteinizingHormone,
                    BiomarkerId.dehydroepiandrosterone,
                    BiomarkerId.follicleStimulatingHormone,
                    BiomarkerId.androstendione,
                    BiomarkerId.dehydroepiandrosteroneSulfate,
                    BiomarkerId.glucose,
                    BiomarkerId.insulin,
                    BiomarkerId.triglycerides,
                    BiomarkerId.ldlCholesterol,
                    BiomarkerId.hydroxyprogesterone17,
                    BiomarkerId.freeAndrogenIndex,
                    BiomarkerId.shbg,
                    BiomarkerId.antiMullerianHormone],
                evaluate: { values in
                    // Extract values for each biomarker
